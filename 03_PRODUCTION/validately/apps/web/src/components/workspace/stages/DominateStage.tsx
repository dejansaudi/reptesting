...
export function DominateStage({ data, update }: StageProps) {
  ...
  return (
    <div>
      ...
      <div className="p-3 bg-surface-2 rounded-lg border border-border mb-4">
        <div className="text-[11px] font-bold text-content mb-2.5">Competitive Moat Scorecard</div>
      ...
      <div className="p-3 bg-surface-2 rounded-lg border border-border mb-4">
        <div className="text-[11px] font-bold text-content mb-2.5">Market Dominance</div>
        <FieldInput label="Market Share (%)" type="number" value={get("market_share")}
          onChange={(v) => update("market_share", v)} placeholder="0-100" />
      </div>

      <div className="p-3 bg-surface-2 rounded-lg border border-border mb-4">
        <div className="text-[11px] font-bold text-content mb-2.5">Financial Health</div>
      ...
      <div className="p-3 bg-surface-2 rounded-lg border border-border mb-4">
        <div className="text-[11px] font-bold text-content mb-2.5">Long-Term Vision</div>
